            ...
            <div style={{marginTop: 96}}>
                ...
                <div id="demo" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item">
                            <img
                                src="https://ik.imagekit.io/tvlk/apr-asset/dgXfoyh24ryQLRcGq00cIdKHRmotrWLNlvG-TxlcLxGkiDwaUSggleJNPRgIHCX6/hotel/asset/10024652-2313x1536-FIT_AND_TRIM-87601f240396646aefeaa5c492a0dc25.jpeg?_src=imagekit&tr=c-at_max,h-360,q-40,w-640"
                                alt="New York"
                                className="d-block"
                                style={{width: "100%", height: 600}}
                            />
                    ...
                    <div className="row container mx-0 px-5 mt-3">
                        ...
                        <div className="col-6 mt-2">
                            ...
                            <h5 style={{
                                ...
                                với nhiều những hương vị ẩm thực châu Á
                                , Ý và châu Âu cùng các món bò nhập khẩu thượng hạng tại đa dạng các nhà hàng, quầy bar
                                đẳng cấp được bao quanh bởi một khu vườn nhiệt đới hay hướng mình ra biển, đón những hơi
                                thở mát mẻ thổi về từ biển đông...
                            </h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row container mx-0 px-5 mt-5">
                        <div className="col-6 mt-2">
                            ...
                            <h5 style={{
                                ...
                                Biến kỳ nghỉ dưỡng năng động hơn bằng cách tham gia các hoạt động thể thao trên nước từ
                                chèo thuyền catamaran, lướt ván buồm, chèo thuyền trên biển, lướt vát, đi xe đạp nước,
                                trượt nước, lướt ván, chuối, dù lượn và đa dạng các hoạt động.
                            </h5>
                        </div>
                        <div className="col-6">
                            <img className="w-100 h-100 shadow"
